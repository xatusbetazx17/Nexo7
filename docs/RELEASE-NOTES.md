...
- About 1.63 GB of optional downloads; generation then works offline. CPU jobs can take minutes. Quality, anatomy, lettering and prompt accuracy remain imperfect.
