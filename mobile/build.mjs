...
for(const name of ['index.html','style.css','manifest.webmanifest','icon.svg','sw.js','LFM-LICENSE.txt'])await cp('src/'+name,'dist/'+name);
...
const files=['./','./index.html','./app.js','./inference.js','./style.css','./manifest.webmanifest','./icon.svg','./wllama.wasm','./LFM-LICENSE.txt','./WLLAMA-LICENSE.txt'];
