...
await cp('src/LFM-LICENSE.txt','dist/LFM-LICENSE.txt');
const files=['./LFM-LICENSE.txt','./','./index.html','./app.js','./inference.js','./style.css','./manifest.webmanifest','./icon.svg',...(await readdir('dist/ort')).map(x=>'./ort/'+x)];
