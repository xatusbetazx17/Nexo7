...
- Mobile optional model: `onnx-community/Qwen2.5-0.5B-Instruct`, revision `cc5cc01a65cc3ff17bdb73a7de33d879f62599b0`, q8; derived from Qwen/Qwen2.5-0.5B-Instruct (Apache-2.0). The model is downloaded from Hugging Face, not included in the app archive. Model card: https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct
